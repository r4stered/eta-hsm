...
#   docs/probes/scaling.csv             raw per-point measurements
#   docs/probes/compile-time-scaling.md the report: curve + go/no-go read
#
...
readonly CSV="${OUT_DIR}/scaling.csv"
readonly REPORT="${OUT_DIR}/compile-time-scaling.md"
...
# ---------------------------------------------------------------------------
{
    echo "# Compile-time scaling probe report"
    echo
